          ...
          >
            ...
            >
              <a
                ...
                className="mb-2 font-semibold text-center lg:text-left cursor-pointer transition-transform duration-300 ease-in-out hover:text-purple-400 hover:scale-105 block"
              >
                {project.title}
              </a>
